...
[filter_remote]
#代理
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/PROXY/Google.yaml, tag=🛸 谷歌服务, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/PROXY/Netflix.yaml, tag=📺 奈飞视频, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/PROXY/Bing.yaml, tag=🔍 必应引擎, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/PROXY/OpenAI.yaml, tag=🤖 OpenAI, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
#直连
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/DIRECT/Apple.yaml, tag=🍎 苹果服务, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/DIRECT/Microsoft.yaml, tag=🪟 微软服务, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
https://raw.githubusercontent.com/CarefreeMontage/proxyrules-cm/main/QuantumultX/DIRECT/China.yaml, tag=🇨🇳 国内地址, force-policy=你的策略组名, update-interval=172800, opt-parser=false, enabled=true
#广告拦截
